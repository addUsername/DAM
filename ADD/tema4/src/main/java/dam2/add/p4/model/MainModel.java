...
import dam2.add.p4.entities.Partida;
import dam2.add.p4.entities.Pregunta;
import dam2.add.p4.interfaces.MainModelImpl;
...
public class MainModel implements MainModelImpl {
	...
	private final String BBDDPROPERTIES = "./properties/bbdd.properties";
	...
	public MainModel() {
		...
		db = DBHelper.createConexion(BBDDPROPERTIES);
	}
	...
	public boolean writeImportedQuestions(boolean shouldOverwrite) {
		...
		return bool;
		*/
		return db.save(currentGame.getPreguntas(), shouldOverwrite);
	}
